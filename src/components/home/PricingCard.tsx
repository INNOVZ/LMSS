        ...
        {plans.map((plan, index) => (
          <motion.div
            ...
            className={`flex flex-col p-6 sm:p-12 rounded-lg border ${
              plan.highlighted
                ? "border-gray-400 dark:border-white shadow-lg relative overflow-hidden z-[-1]"
                : "border-gray-200 dark:border-gray-800"
            }`}
          >
            {plan.highlighted && (
              <div className="absolute top-0 right-0 bg-gradient-to-r from-[#676767] to-gray-200">
                <div className="dark:bg-white text-white dark:text-black text-xs font-medium px-3 py-1 rounded-bl-lg z-[-1]">
                  Popular
                </div>
              </div>
            )}
            ...
            <div className="mb-5">
              <h3
                className={`text-xl font-bold ${
                  plan.highlighted
                    ? "bg-gradient-to-r from-[#676767] to-gray-400 text-transparent bg-clip-text"
            ...
            <button
              className={`py-3 px-4 rounded-md font-medium ${
                plan.highlighted
                  ? "pointer bg-gradient-to-r from-[#676767] to-gray-400 hover:bg-gray-800 text-white dark:bg-white dark:hover:bg-gray-200 dark:text-black"
                  : "pointer bg-gray-100 hover:bg-gray-200 text-gray-900 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-100"
              }`}
            >
              {plan.cta}
            </button>
